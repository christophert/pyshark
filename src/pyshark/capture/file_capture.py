...
class FileCapture(Capture):
    ...
    def __init__(self, input_file=None, keep_packets=True, display_filter=None, only_summaries=False,
                 decryption_key=None, encryption_type='wpa-pwk', decode_as=None, tshark_path=None, sslkey_list=None,
                 override_prefs=None):
        """
	...
	:param sslkey_list: SSL keylist for decrypting TLS packets
        ...
        super(FileCapture, self).__init__(display_filter=display_filter, only_summaries=only_summaries,
                                          ...
                                          decode_as=decode_as, tshark_path=tshark_path, sslkey_list=sslkey_list, override_prefs=override_prefs)
